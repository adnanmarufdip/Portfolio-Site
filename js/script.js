...
function navBar_toggle() { 
	...
	if (document.body.scrollTop > 100 || document.documentElement.scrollTop > 100) {
        document.getElementById("floating_nav").style.top = "0";
	}
	else {
        document.getElementById("floating_nav").style.top = "-98px";
    }
}
...
function RequestClass() {
    ...
    // else { // setting Home as active on page load
    //     ulLink1[0].Class = 1;
    //     ulLink2[0].Class = 1;
    //     AddClass();
    // }
...
function AddClass() {
    ...
    for(var i = 0; i < ulLink2.length; i++){
            if(ulLink2[i].Class == 1){
                document.getElementById(ulLink2[i].ID).classList.add("Active");
            }
        }
}
...
function RemoveClass() {
    ...
    for(var i = 0; i < ulLink2.length; i++){
            if( i != indx2){
                document.getElementById(ulLink2[i].ID).classList.remove("Active");
                ulLink2[i].Class = 0;
            }
        }
}
